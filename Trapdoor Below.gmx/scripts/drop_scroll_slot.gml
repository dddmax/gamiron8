dropped_scroll=instance_create(o_player.x,o_player.y,o_tile_scroll)

dropped_scroll.name=global.item[argument0,0]
dropped_scroll.sprite_index=global.item[argument0,1]
dropped_scroll.amount=global.item[argument0,3]
dropped_scroll.effect=global.item[argument0,5]
